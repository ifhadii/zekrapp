...
var zekrContainer = document.getElementById("zekrContainer");

var title = document.createElement("h1");
title.textContent = zekr_obj.title;
zekrContainer.appendChild(title);

zekr_obj.content.forEach(item => {
  var zekrParagraph = document.createElement("p");
  zekrParagraph.textContent = item.zekr;
  zekrContainer.appendChild(zekrParagraph);

  var repeatParagraph = document.createElement("div");
  repeatParagraph.textContent = item.repeat;
  zekrContainer.appendChild(repeatParagraph);

  var blessParagraph = document.createElement("p");
  blessParagraph.textContent = item.bless;
  // zekrContainer.appendChild(blessParagraph);
});